...
- [x] 02-01-PLAN.md — Tracer: `PATCH /tasks/{taskId}/move` publishes `TaskMovedEvent` after commit (wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 02-02-PLAN.md — The four remaining domain events across Task/Board/Column services (wave 2)
- [x] 02-03-PLAN.md — Local Kafka stack: docker-compose with KRaft broker behind a health gate (wave 2)
...
- [x] 03-01-PLAN.md — Tracer: an event on a real broker becomes a persisted, deduplicated `activity_log` row (wave 1)
...
| 3. Activity Log Consumer, Reliability & Read API | 1/3 | In Progress|  |
