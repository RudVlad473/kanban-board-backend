...
last_updated: "2026-08-03T16:40:00.000Z"
last_activity: 2026-08-03
last_activity_desc: Completed quick task 260803-m3i (deleted the two dead hash-less UserMapper overloads; tightened UserEntity.passwordHash to non-nullable with a guarded production DDL bridge script, NOT yet applied to the real database; closed the source todo; filed a new security-marked todo for the entity-to-request-DTO hash-leak found while re-verifying callers)
progress:
  total_phases: 3
  completed_phases: 2
  total_plans: 6
...
- [security] `UserMapper`'s entity-to-request-DTO methods (`toSigninRequestDTO`, `toSignupRequestDTO`) copy the stored bcrypt hash into a `password`-named DTO field via MapStruct name matching — uncalled today, but latent. See `.planning/todos/pending/2026-08-03-usermapper-entity-to-request-dto-methods-leak-the-bcrypt-hash.md`.
