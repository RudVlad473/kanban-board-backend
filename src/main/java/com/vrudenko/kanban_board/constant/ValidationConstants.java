...
public final class ValidationConstants {
    ...
    public static final String NAME_LENGTH_VALIDATION_MESSAGE = "Board name cannot be less than "
    ...
    public static final String DISPLAY_NAME_LENGTH_VALIDATION_MESSAGE = "Display name cannot be less than "
    ...
    public static final String PASSWORD_LENGTH_VALIDATION_MESSAGE = "Password cannot be less than "
    ...
    public static final String COLUMN_NAME_LENGTH_VALIDATION_MESSAGE = "Column name cannot be less than "
    ...
    public static final String TASK_TITLE_LENGTH_VALIDATION_MESSAGE = "Task title cannot be less than "
    ...
    public static final String TASK_DESCRIPTION_LENGTH_VALIDATION_MESSAGE = "Task description cannot be less than "
            + ValidationConstants.MIN_TASK_TITLE_LENGTH
            + " character and more than "
            + ValidationConstants.MAX_TASK_TITLE_LENGTH
            + " characters";
    ...
    public static final String SUBTASK_TITLE_LENGTH_VALIDATION_MESSAGE = "Subtask title cannot be less than "
