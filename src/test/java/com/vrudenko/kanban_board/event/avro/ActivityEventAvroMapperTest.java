...
/**
 * No mocks, no container (CODE_STYLE rule 4 / plan Task 3): {@link ActivityEventAvroMapper} touches
 * neither Kafka nor a database, so a plain Spring context is sufficient to autowire it.
 */
@SpringBootTest
